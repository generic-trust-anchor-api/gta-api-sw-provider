...
static struct profile_list_t supported_profiles[NUM_PROFILES] = {
    ...
    [PROF_CH_IEC_30168_BASIC_LOCAL_DATA_INTEGRITY_ONLY] = {"ch.iec.30168.basic.local_integrity_only",
                                                           &fl_prof_ch_iec_30168_basic_local_data_integrity_only},
    [PROF_CH_IEC_30168_BASIC_LOCAL_DATA_PROTECTION] = {"ch.iec.30168.basic.local_data_protection",
                                                       &fl_prof_ch_iec_30168_basic_local_data_protection},
    [PROF_COM_GITHUB_GENERIC_TRUST_ANCHOR_API_BASIC_RSA] = {"com.github.generic-trust-anchor-api.basic.rsa",
                                                            &fl_prof_com_github_generic_trust_anchor_api_basic_rsa},
    [PROF_COM_GITHUB_GENERIC_TRUST_ANCHOR_API_BASIC_EC] = {"com.github.generic-trust-anchor-api.basic.ec",
                                                           &fl_prof_com_github_generic_trust_anchor_api_basic_ec},
#ifdef ENABLE_PQC
    ...
    [PROF_COM_GITHUB_GENERIC_TRUST_ANCHOR_API_BASIC_JWT] = {"com.github.generic-trust-anchor-api.basic.jwt",
                                                            &fl_prof_com_github_generic_trust_anchor_api_basic_jwt},
 ...
 */
static bool check_context_params(const struct gta_sw_provider_context_params_t * p_context_params,
...
static bool get_personality_fingerprint(struct personality_name_list_item_t * p_personality_name_list,
                                        ...
                                        gta_errinfo_t * p_errinfo)
{
    ...
    if (NULL != p_personality) {
        p_personality_attribute = list_find((struct list_t *)p_personality->p_personality_content->p_attribute_list,
                                            (unsigned char *)PERS_ATTR_NAME_FINGERPRINT, attribute_list_item_cmp_name);
        if (NULL != p_personality_attribute) {
            memcpy(*target_personality_fingerprint, p_personality_attribute->p_data,
                   p_personality_attribute->data_size);
...
bool find_access_token(void * p_item, void * p_item_crit)
{
    ...
    if (0 == memcmp(((struct provider_instance_auth_token_t *)p_item)->access_token,
                    (struct gta_access_token_t *)p_item_crit, GTA_ACCESS_TOKEN_LEN)) {
        return true;
    } else {
        return false;
    }
...
bool find_matching_access_policy(void * p_item, void * p_item_crit)
{
    ...
    if (GTA_ACCESS_DESCRIPTOR_TYPE_PERS_DERIVED_TOKEN == p_provider_instance_auth_token->type) {
        ...
        if ((0 != memcmp(p_auth_info_list_item->binding_personality_fingerprint,
 ...
 */
bool check_access_permission(struct gta_sw_provider_context_params_t * p_context_params,
                             struct gta_sw_provider_params_t * p_provider_params, gta_access_token_usage_t usage,
                             gta_errinfo_t * p_errinfo)
{
    ...
    p_personality_attribute =
        list_find((struct list_t *)p_context_params->p_personality_item->p_personality_content->p_attribute_list,
                  (unsigned char *)PERS_ATTR_NAME_FINGERPRINT, attribute_list_item_cmp_name);
    if (NULL == p_personality_attribute) {
        *p_errinfo = GTA_ERROR_INTERNAL_ERROR;
        return false;
    ...
    while (NULL != access_token_list_item) {
        ...
        p_auth_token = list_find((struct list_t *)p_provider_params->p_auth_token_list,
                                 access_token_list_item->access_token, find_access_token);
        if ((NULL != p_auth_token) &&
            ...
            && (0 == memcmp(p_personality_attribute->p_data, p_auth_token->target_personality_fingerprint,
                            sizeof(gta_personality_fingerprint_t))) &&
...
GTA_DEFINE_FUNCTION(const struct gta_function_list_t *, gta_sw_provider_init,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * provider_init_config, gtaio_ostream_t * logging,
                     void ** pp_params, void (**ppf_free_params)(void * p_params), gta_errinfo_t * p_errinfo))
{
    ...
    *ppf_free_params = gta_sw_provider_free_params;
    ...
    if (1 != RAND_bytes((unsigned char *)(p_provider_params->provider_instance_auth_token_info.issuing_token),
    ...
    /* configure provider */
    if (provider_init_config->read(provider_init_config, p_provider_params->p_serializ_path, SERIALIZE_PATH_LEN_MAX,
                                   p_errinfo) > SERIALIZE_PATH_LEN_MAX) {
    ...
    if (serialized_file_exists(p_provider_params->p_serializ_path)) {
        ...
        if (!provider_deserialize(p_provider_params->p_serializ_path, &(p_provider_params->p_devicestate_stack),
...
static bool generate_access_token(struct provider_instance_auth_token_t * p_auth_token_list_item)
{
    ...
    if (1 != EVP_DigestUpdate(ctx, p_auth_token_list_item->target_personality_fingerprint,
    ...
    if (1 != EVP_DigestUpdate(ctx, p_auth_token_list_item->binding_personality_fingerprint,
                              sizeof(p_auth_token_list_item->binding_personality_fingerprint))) {
        goto err;
    }
    if (1 != EVP_DigestUpdate(ctx, &(p_auth_token_list_item->derivation_profile),
                              sizeof(p_auth_token_list_item->derivation_profile))) {
        goto err;
    }
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_access_token_get_physical_presence,
                    (gta_instance_handle_t h_inst, gta_access_token_t physical_presence_token,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_params_t * p_provider_params = NULL;
                    ...
                    (gta_instance_handle_t h_inst, gta_access_token_t granting_token, gta_errinfo_t * p_errinfo))
{
    ...
    if (!p_provider_params->provider_instance_auth_token_info.issuing_token_issued) {
        memcpy(granting_token, p_provider_params->provider_instance_auth_token_info.issuing_token,
               sizeof(gta_access_token_t));
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_access_token_get_basic,
                    (gta_instance_handle_t h_inst, const gta_access_token_t granting_token,
                     const gta_personality_name_t target_personality_name, gta_access_token_usage_t usage,
                     gta_access_token_t basic_access_token, gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_params_t * p_provider_params = NULL;
    struct provider_instance_auth_token_t * p_auth_token_list_item = NULL;
    gta_errinfo_t errinfo_tmp = 0;
    ...
    if ((!p_provider_params->provider_instance_auth_token_info.issuing_token_issued) ||
        ...
        (0 != memcmp(p_provider_params->provider_instance_auth_token_info.issuing_token, granting_token,
                     sizeof(gta_access_token_t)))) {
    ...
    if (!get_personality_fingerprint(p_provider_params->p_devicestate_stack->p_personality_name_list,
                                     target_personality_name, &(p_auth_token_list_item->target_personality_fingerprint),
                                     p_errinfo)) {
        goto err;
    }
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_access_token_get_pers_derived,
                    (gta_context_handle_t h_ctx, const gta_personality_name_t target_personality_name,
                     gta_access_token_usage_t usage, gta_access_token_t * p_pers_derived_access_token,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_params_t * p_provider_params = NULL;
    struct provider_instance_auth_token_t * p_auth_token_list_item = NULL;
                    ...
                    (gta_instance_handle_t h_inst, gta_access_token_t access_token_tbr, gta_errinfo_t * p_errinfo))
{
    ...
    if (0 == memcmp(p_provider_params->provider_instance_auth_token_info.issuing_token, access_token_tbr,
                    sizeof(gta_access_token_t))) {
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_context_get_attribute,
                    (gta_context_handle_t h_ctx, const gta_context_attribute_type_t attrtype,
                     gtaio_ostream_t * p_attrvalue, gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_context_params_t * p_context_params = NULL;
    ...
    return supported_profiles[p_context_params->profile].pFunction->context_get_attribute(p_context_params, attrtype,
                                                                                          p_attrvalue, p_errinfo);
}

GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_context_set_attribute,
                    (gta_context_handle_t h_ctx, const gta_context_attribute_type_t attrtype,
                     gtaio_istream_t * p_attrvalue, gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_context_params_t * p_context_params = NULL;
    const struct gta_sw_provider_params_t * p_provider_params = NULL;
    ...
    /* call profile specific implementation */
    return supported_profiles[p_context_params->profile].pFunction->context_set_attribute(p_context_params, attrtype,
                                                                                          p_attrvalue, p_errinfo);
}

GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_provider_context_open,
                    (gta_context_handle_t h_ctx, const gta_personality_name_t personality,
                     const gta_profile_name_t profile, void ** pp_params, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
    ...
    while (NULL != p_devicestate_stack_item) {
        p_personality_item = list_find((struct list_t *)p_devicestate_stack_item->p_personality_name_list, personality,
 ...
 */
static bool policy_copy_helper(gta_context_handle_t h_ctx, gta_access_policy_handle_t h_auth,
                               struct auth_info_list_item_t ** p_auth_info_list, bool b_recede_policy,
                               gta_errinfo_t * p_errinfo)
{
    ...
    while (gta_access_policy_enumerate(h_auth, &h_enum, &h_access_descriptor, &errinfo_tmp)) {
        ...
        if (!gta_access_policy_get_access_descriptor_type(h_auth, h_access_descriptor, &access_descriptor_type,
                                                          p_errinfo)) {
            goto internal_err;
        }
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_devicestate_transition,
                    (gta_instance_handle_t h_inst, gta_access_policy_handle_t h_auth_recede, size_t owner_lock_count,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_params_t * p_provider_params = NULL;
    ...
    if (!policy_copy_helper(p_provider_params->h_ctx, h_auth_recede,
                            &(p_provider_params->p_devicestate_stack->p_auth_recede_info_list), true, p_errinfo)) {
        goto err;
    }
...
err:
    ...
    auth_info_list_destroy(p_provider_params->h_ctx, p_provider_params->p_devicestate_stack->p_auth_recede_info_list,
                           &errinfo_tmp);
    p_provider_params->p_devicestate_stack->p_auth_recede_info_list = NULL;
    p_provider_params->p_devicestate_stack->owner_lock_count = 0;
    return false;
                    ...
                    (gta_instance_handle_t h_inst, gta_access_token_t access_token, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_provider_params->p_devicestate_stack->p_auth_recede_info_list) {
        ...
        if ((NULL == p_auth_token)
            ...
            /* Now we look for a policy which can be fulfilled by this token */
            || (NULL == list_find((struct list_t *)&(p_provider_params->p_devicestate_stack->p_auth_recede_info_list),
                                  p_auth_token, find_matching_access_policy))) {
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_devicestate_attestate,
                    (gta_context_handle_t h_context, gtaio_istream_t * nonce, gtaio_ostream_t * attestation,
                     gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_identifier_assign,
                    (gta_instance_handle_t h_inst, const gta_identifier_type_t identifier_type,
                     const gta_identifier_value_t identifier_value, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
    ...
    if (NULL != (p_identifier_list_item = gta_secmem_calloc(p_provider_params->h_ctx, 1,
                                                            sizeof(struct identifier_list_item_t), p_errinfo))) {
        ...
        if ((0 != identifier_type_length) && (IDENTIFIER_TYPE_MAXLEN != identifier_type_length) &&
            ...
            if ((NULL != (p_identifier_list_item->type = gta_secmem_calloc(p_provider_params->h_ctx, 1,
                                                                           (identifier_type_length + 1), p_errinfo))) &&
                ...
                *(p_identifier_list_item->name + identifier_value_length) = 0;
                ...
                list_append_front((struct list_t **)(&(p_provider_params->p_devicestate_stack->p_identifier_list)),
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_identifier_enumerate,
                    (gta_instance_handle_t h_inst, gta_enum_handle_t * ph_enum, gtaio_ostream_t * identifier_type,
                     gtaio_ostream_t * identifier_value, gta_errinfo_t * p_errinfo))
{
    ...
    if (NULL != p_identifier_list_item) {
        ...
        identifier_type->write(identifier_type, p_identifier_list_item->type,
                               strnlen(p_identifier_list_item->type, IDENTIFIER_TYPE_MAXLEN), &errinfo);
        identifier_type->write(identifier_type, "", 1, &errinfo);
        identifier_value->write(identifier_value, p_identifier_list_item->name,
                                strnlen(p_identifier_list_item->name, IDENTIFIER_VALUE_MAXLEN), &errinfo);
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_enumerate,
                    (gta_instance_handle_t h_inst, const gta_identifier_value_t identifier_value,
                     gta_enum_handle_t * ph_enum, gta_personality_enum_flags_t flags,
                     gtaio_ostream_t * personality_name, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
    ...
    while (NULL != p_devicestate_stack_item) {
        ...
        if (NULL != p_personality_name_list_item) {
            if ((0 != strncmp(p_personality_name_list_item->p_identifier_list_item->name, identifier_value,
    ...
    if (NULL != p_personality_name_list_item) {
        ...
        personality_name->write(personality_name, p_personality_name_list_item->personality_name,
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_enumerate_application,
                    (gta_instance_handle_t h_inst, const gta_application_name_t application_name,
                     gta_enum_handle_t * ph_enum, gta_personality_enum_flags_t flags,
                     gtaio_ostream_t * personality_name, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
 ...
 * caller.
 */
bool add_personality_attribute_list_item(struct gta_sw_provider_params_t * p_provider_params,
                                         struct personality_attribute_t ** p_pers_attribute_list,
                                         const enum pers_attr_type_t attrtype, const unsigned char * attrname,
                                         const size_t attrname_len, const unsigned char * attrval,
                                         const size_t attrval_len, const bool b_trusted, gta_errinfo_t * p_errinfo)
{
...
static bool personality_deploy_create(gta_instance_handle_t h_inst, const gta_identifier_value_t identifier_value,
                                      const gta_personality_name_t personality_name,
                                      const gta_application_name_t application, const gta_profile_name_t profile,
                                      gtaio_istream_t * personality_content, gta_access_policy_handle_t h_auth_use,
                                      ...
                                      gta_errinfo_t * p_errinfo)
{
    ...
    if (NULL == personality_content) {
        ...
        if (!supported_profiles[prof].pFunction->personality_create(
                p_provider_params, personality_name, &personality_secret_type, &p_secret_buffer, &len,
                personality_fingerprint, &p_pers_specific_attributes, p_errinfo)) {
            goto err;
        }
    } else {
        /* check whether function is supported by profile */
        ...
        if (!supported_profiles[prof].pFunction->personality_deploy(
                p_provider_params, personality_name, personality_content, &personality_secret_type, &p_secret_buffer,
                &len, personality_fingerprint, &p_pers_specific_attributes, p_errinfo)) {
            goto err;
        }
    }
    ...
    if (!policy_copy_helper(p_provider_params->h_ctx, h_auth_use,
                            &(p_personality_name_list_item->p_personality_content->p_auth_use_info_list), false,
                            p_errinfo)) {
        goto err;
    }

    if (!policy_copy_helper(p_provider_params->h_ctx, h_auth_admin,
                            &(p_personality_name_list_item->p_personality_content->p_auth_admin_info_list), false,
                            p_errinfo)) {
        goto err;
    }
    ...
    if (!add_personality_attribute_list_item(
            p_provider_params, &p_personality_name_list_item->p_personality_content->p_attribute_list,
            PAT_CH_IEC_30168_IDENTIFIER, (unsigned char *)PERS_ATTR_NAME_IDENTIFIER, sizeof(PERS_ATTR_NAME_IDENTIFIER),
            (unsigned char *)identifier_value, strnlen(identifier_value, IDENTIFIER_VALUE_MAXLEN), true, p_errinfo)) {

        goto err;
    }
    if (!add_personality_attribute_list_item(
            p_provider_params, &p_personality_name_list_item->p_personality_content->p_attribute_list,
            PAT_CH_IEC_30168_FINGERPRINT, (unsigned char *)PERS_ATTR_NAME_FINGERPRINT,
            sizeof(PERS_ATTR_NAME_FINGERPRINT), (unsigned char *)personality_fingerprint,
            sizeof(personality_fingerprint), true, p_errinfo)) {
    ...
    /* add the personality */
    list_append_front((struct list_t **)(&(p_provider_params->p_devicestate_stack->p_personality_name_list)),
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_deploy,
                    (gta_instance_handle_t h_inst, const gta_identifier_value_t identifier_value,
                     const gta_personality_name_t personality_name, const gta_application_name_t application,
                     const gta_profile_name_t profile, gtaio_istream_t * personality_content,
                     gta_access_policy_handle_t h_auth_use, gta_access_policy_handle_t h_auth_admin,
                     struct gta_protection_properties_t requested_protection_properties, gta_errinfo_t * p_errinfo))
{
    return personality_deploy_create(h_inst, identifier_value, personality_name, application, profile,
                                     personality_content, h_auth_use, h_auth_admin, requested_protection_properties,
                                     p_errinfo);
}
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_create,
                    (gta_instance_handle_t h_inst, const gta_identifier_value_t identifier_value,
                     const gta_personality_name_t personality_name, const gta_application_name_t application,
                     const gta_profile_name_t profile, gta_access_policy_handle_t h_auth_use,
                     gta_access_policy_handle_t h_auth_admin,
                     struct gta_protection_properties_t requested_protection_properties, gta_errinfo_t * p_errinfo))
{
    return personality_deploy_create(h_inst, identifier_value, personality_name, application, profile, NULL, h_auth_use,
                                     h_auth_admin, requested_protection_properties, p_errinfo);
}

GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_enroll,
                    (gta_context_handle_t h_ctx, gtaio_ostream_t * p_personality_enrollment_info,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_context_params_t * p_context_params = NULL;
    struct gta_sw_provider_params_t * p_provider_params = NULL;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_enroll_auth,
                    (gta_context_handle_t h_ctx, gta_context_handle_t h_auth_ctx,
                     gtaio_ostream_t * p_personality_enrollment_info, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_attestate,
                    (gta_context_handle_t h_ctx, const gta_personality_name_t personality_name, gtaio_istream_t * nonce,
                     gtaio_ostream_t * p_attestation_data, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
                    ...
                    (gta_context_handle_t h_ctx, gta_errinfo_t * p_errinfo))
{
    ...
    while (NULL != p_devicestate_stack_item) {
        ...
        p_personality_item =
            list_remove((struct list_t **)(&p_devicestate_stack_item->p_personality_name_list),
 ...
 */
bool personality_add_attribute(struct gta_sw_provider_context_params_t * p_context_params,
                               struct gta_sw_provider_params_t * p_provider_params,
                               const gta_personality_attribute_type_t attrtype,
                               const gta_personality_attribute_name_t attrname, gtaio_istream_t * p_attrvalue,
                               const bool b_trusted, gta_errinfo_t * p_errinfo)
{
    ...
    if (add_personality_attribute_list_item(
            p_provider_params, &p_context_params->p_personality_item->p_personality_content->p_attribute_list,
            pers_attr_type, (unsigned char *)attrname, attrname_len, attrval, attrval_len, b_trusted, p_errinfo)) {
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_add_trusted_attribute,
                    (gta_context_handle_t h_ctx, const gta_personality_attribute_type_t attrtype,
                     const gta_personality_attribute_name_t attrname, gtaio_istream_t * p_attrvalue,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_params_t * p_provider_params = NULL;
    ...
    return personality_add_attribute(p_context_params, p_provider_params, attrtype, attrname, p_attrvalue, true,
                                     p_errinfo);
}
                     ...
                     gta_errinfo_t * p_errinfo))
{
    ...
    return personality_add_attribute(p_context_params, p_provider_params, attrtype, attrname, p_attrvalue, false,
                                     p_errinfo);
}

GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_get_attribute,
                    (gta_context_handle_t h_ctx, const gta_personality_attribute_name_t attrname,
                     gtaio_ostream_t * p_attrvalue, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
    struct gta_sw_provider_context_params_t * p_context_params = NULL;
 ...
 */
bool find_activated_nondefault_attribute(struct gta_sw_provider_context_params_t * p_context_params,
                                         struct personality_attribute_t ** p_attribute,
                                         const gta_personality_attribute_name_t attrname, gta_errinfo_t * p_errinfo)
{
    /* Find attribute_list_item with requested name and check whether it is activated */
    *p_attribute =
        list_find((struct list_t *)(p_context_params->p_personality_item->p_personality_content->p_attribute_list),
                     ...
                     gta_errinfo_t * p_errinfo))
{
     ...
     */
    p_attribute =
        list_remove((struct list_t **)(&p_context_params->p_personality_item->p_personality_content->p_attribute_list),
                    attrname, attribute_list_item_cmp_name);
    if (NULL == p_attribute) {
        *p_errinfo = GTA_ERROR_ITEM_NOT_FOUND;
        goto err;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_personality_attributes_enumerate,
                    (gta_instance_handle_t h_inst, const gta_personality_name_t personality_name,
                     gta_enum_handle_t * ph_enum, gtaio_ostream_t * attribute_type, gtaio_ostream_t * attribute_name,
                     gta_errinfo_t * p_errinfo))
{
    /* @todo The direct exposure of an internal pointer through ph_enum
            is not ideal. Using a handle map as in the GTA API framework
    ...
    p_devicestate_stack_item = p_provider_params->p_devicestate_stack;
    while (NULL != p_devicestate_stack_item) {
        p_personality_name_list_item = list_find((struct list_t *)p_devicestate_stack_item->p_personality_name_list,
                                                 personality_name, personality_list_item_cmp_name);
        if (NULL == p_personality_name_list_item) {
            p_devicestate_stack_item = p_devicestate_stack_item->p_next;
        } else {
            /* Personality found, exit the Loop */
    ...
    if (NULL != p_personality_attribute) {
        ...
        attribute_type->write(
            attribute_type, pers_attr_type_strings[p_personality_attribute->type],
        ...
        attribute_name->write(attribute_name, p_personality_attribute->p_name,
                              strnlen(p_personality_attribute->p_name, MAXLEN_PERSONALITY_ATTRIBUTE_NAME), &errinfo);
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_seal_data,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * data, gtaio_ostream_t * protected_data,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_context_params_t * p_context_params = NULL;
    struct gta_sw_provider_params_t * p_provider_params = NULL;
    ...
    /* call profile specific implementation */
    return supported_profiles[p_context_params->profile].pFunction->seal_data(p_context_params, data, protected_data,
                                                                              p_errinfo);
}

GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_unseal_data,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * protected_data, gtaio_ostream_t * data,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_context_params_t * p_context_params = NULL;
    struct gta_sw_provider_params_t * p_provider_params = NULL;
    ...
    /* call profile specific implementation */
    return supported_profiles[p_context_params->profile].pFunction->unseal_data(p_context_params, protected_data, data,
                                                                                p_errinfo);
}
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_authenticate_data_detached,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * data, gtaio_ostream_t * seal,
                     gta_errinfo_t * p_errinfo))
{
    struct gta_sw_provider_context_params_t * p_context_params = NULL;
    struct gta_sw_provider_params_t * p_provider_params = NULL;
    ...
    /* call profile specific implementation */
    return supported_profiles[p_context_params->profile].pFunction->authenticate_data_detached(p_context_params, data,
                                                                                               seal, p_errinfo);
}

GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_verify_data_detached,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * data, gtaio_istream_t * seal,
                     gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_security_association_initialize,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * in, gtaio_ostream_t * out, bool * pb_finished,
                     gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_seal_message,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * msg, gtaio_ostream_t * sealed_msg,
                     gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_unseal_message,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * sealed_msg, gtaio_ostream_t * msg,
                     gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_attestate,
                    (gta_context_handle_t h_ctx, gtaio_istream_t * nonce, gtaio_ostream_t * attestation_data,
                     gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_trustex_function_install,
                    (const char * function_name, gta_profile_name_t profile_name, gtaio_istream_t function,
                     gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
GTA_DEFINE_FUNCTION(bool, gta_sw_provider_gta_trustex_function_execute,
                    (const char * function_name, gta_handle_t function_handle, gtaio_istream_t input,
                     gtaio_ostream_t output, gta_errinfo_t * p_errinfo))
{
    bool ret = false;
...
static const struct gta_function_list_t g_my_function_list = {gta_sw_provider_gta_access_token_get_physical_presence,
