...
bool personality_attribute_list_item_free(gta_context_handle_t h_ctx, struct personality_attribute_t * p_attribute_item,
...
/* free an Auth Info */
bool auth_info_list_item_free(gta_context_handle_t h_ctx, struct auth_info_list_item_t * p_auth_info_item,
                              gta_errinfo_t * p_errinfo)
{
...
bool auth_info_list_destroy(gta_context_handle_t h_ctx, struct auth_info_list_item_t * p_auth_info_list_head,
                            gta_errinfo_t * p_errinfo)
{
...
bool personality_content_free(gta_context_handle_t h_ctx, struct personality_t * p_personality_content,
                              gta_errinfo_t * p_errinfo)
{
                                   ...
                                   gta_errinfo_t * p_errinfo)
{
    ...
    while (NULL !=
           (p_personality_name_list_item = list_remove_front((struct list_t **)(&p_personality_name_list_head)))) {
...
/* free an Identifier */
bool identifier_list_item_free(gta_context_handle_t h_ctx, struct identifier_list_item_t * p_identifier_item,
                               gta_errinfo_t * p_errinfo)
{
...
bool identifier_list_destroy(gta_context_handle_t h_ctx, struct identifier_list_item_t * p_identifier_list_head,
                             gta_errinfo_t * p_errinfo)
{
