...
const enum pers_attr_type_t supported_pers_attr_types[] = {
...
GTA_SWP_DEFINE_FUNCTION(bool, personality_attribute_type_supported,
(
    const enum pers_attr_type_t pers_attr_type
))
{
    return pers_attr_type_supported(supported_pers_attr_types, SIZEOF(supported_pers_attr_types), pers_attr_type);
}
...
const struct profile_function_list_t fl_prof_com_github_generic_trust_anchor_api_basic_tls = {
    ...
    .personality_attribute_type_supported = personality_attribute_type_supported,
