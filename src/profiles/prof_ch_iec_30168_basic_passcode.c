...
GTA_SWP_DEFINE_FUNCTION(bool, personality_deploy,
                        (struct gta_sw_provider_params_t * p_provider_params, gta_personality_name_t personality_name,
                         gtaio_istream_t * personality_content, personality_secret_type_t * p_pers_secret_type,
                         unsigned char ** p_pers_secret_buffer, size_t * p_pers_secret_length,
...
GTA_SWP_DEFINE_FUNCTION(bool, verify,
                        (struct gta_sw_provider_context_params_t * p_context_params, gtaio_istream_t * claim,
