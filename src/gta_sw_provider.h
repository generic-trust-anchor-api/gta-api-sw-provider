...
struct profile_function_list_t {
    ...
    bool (*context_get_attribute)(struct gta_sw_provider_context_params_t *, gta_context_attribute_type_t,
                                  gtaio_ostream_t *, gta_errinfo_t *);
    bool (*context_set_attribute)(struct gta_sw_provider_context_params_t *, gta_context_attribute_type_t,
                                  gtaio_istream_t *, gta_errinfo_t *);
    bool (*personality_deploy)(struct gta_sw_provider_params_t *, gta_personality_name_t, gtaio_istream_t *,
                               personality_secret_type_t *, unsigned char **, size_t *, gta_personality_fingerprint_t,
                               struct personality_attribute_t **, gta_errinfo_t *);
    bool (*personality_create)(struct gta_sw_provider_params_t *, gta_personality_name_t, personality_secret_type_t *,
                               unsigned char **, size_t *, gta_personality_fingerprint_t,
                               struct personality_attribute_t **, gta_errinfo_t *);
    ...
    bool (*unseal_data)(struct gta_sw_provider_context_params_t *, gtaio_istream_t *, gtaio_ostream_t *,
                        gta_errinfo_t *);
    bool (*verify)(struct gta_sw_provider_context_params_t *, gtaio_istream_t *, gta_errinfo_t *);
    bool (*authenticate_data_detached)(struct gta_sw_provider_context_params_t *, gtaio_istream_t *, gtaio_ostream_t *,
                                       gta_errinfo_t *);
};
