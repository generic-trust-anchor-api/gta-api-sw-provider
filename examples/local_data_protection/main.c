...
int main (int argc, char *argv[])
{
    ...
    if (0 == strcmp(argv[1], "init")) {
        ...
        if (!gta_personality_create(h_inst, "local", "local-pers", "local-application",
            "ch.iec.30168.basic.local_data_protection", h_auth, h_auth, protection_properties, &errinfo)) {
...
bool create_gta_instance (gta_instance_handle_t *h_inst, char *p_state_dir)
{
    ...
    struct gta_provider_info_t provider_info = {
        ...
        .profile_info = {
            .profile_name = "ch.iec.30168.basic.local_data_protection",
